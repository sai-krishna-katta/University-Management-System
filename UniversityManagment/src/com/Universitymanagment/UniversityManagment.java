...
import com.University.exception.CourseNotFooundException;
...
public class UniversityManagment {
	...
	public void enrollStudentInCourse(String studentName, String courseTitle)
			throws StudentNotFoundException, CourseNotFooundException {
		...
		if (course == null) {
			throw new CourseNotFooundException("Course " + courseTitle + " not found.");
		}
	...
	public void assignCourseToProfessor(String professorName, String courseTitle)
			throws ProfessorNotFoundException, CourseNotFooundException {
	...
	public void listCourses() {
		if (courses.isEmpty()) {
			...
			for (Course coursee : courses) {
				System.out.println(coursee); // Print each course's title
			}
		}
	}
		...
		while (running) {
			...
			try {
				...
				case 4:
					...
					} catch (StudentNotFoundException | CourseNotFooundException e) {
				...
				case 5:
					...
					} catch (ProfessorNotFoundException | CourseNotFooundException e) {
						System.out.println(e.getMessage()); // Handle exception
					}
					break;
				case 6:
